...
namespace UI
{
    ...
    public:
        ...
        // lifecycle ----------------------------------------------------------
        virtual void mount() { mounted = true; }
        virtual void unmount() { mounted = false; }
    ...
    public:
        ...
        // event handlers ------------------------------------------------------
        void setTouchHandler(EventHandler h) { touchHandler = std::move(h); }
        void setTouchEndHandler(EventHandler h) { touchEndHandler = std::move(h); }
