...
namespace UI
{
    ...
    {
    public:
        void addButton(RadioButton *btn) { buttons.push_back(btn); }
        void selectButton(RadioButton *btn);
        RadioButton *getSelected() const { return selected; }
    ...
    public:
        ...
        RadioButton(const String &txt = String(), int ix = 0, int iy = 0, int iw = 0, int ih = 0)
            : labelText(txt)
        {
        ...
        void setLabel(const String &txt) { labelText = txt; }
