...
public:
    ...
    void setMinimizeCallback(MinimizeCallback cb)
    {
        onMinimize = std::move(cb);
    }
    ...
    {
        return scrollableContent.getContent();
    }
    ...
    MenuBar *getMenuBar()
    {
        return hasMenuBar ? &menuBar : nullptr;
    }
    ...
    {
        return winState == WindowState::Minimized;
    }
    ...
    void cycleWindowState()
    {
        ...
        if (onStateChange)
        {
            ...
            UI::queueAction([cb, newState]() { cb(newState); });
        }
    }
    ...
    int contentX() const
    {
        return x + Theme::WindowBorderWidth;
    }
    int contentY() const
    {
    ...
    int contentW() const
    {
        return width - Theme::WindowBorderWidth * 2;
    }
    int contentH() const
    {
